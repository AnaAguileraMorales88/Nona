    ...
    return (
        ...
        >
        <h2 className="text-white text-7xl sm:text-8xl md:text-9xl font-bold tracking-wider mb-4 -mt-10 md:-mt-60">
            NONA
        </h2>
        <h3 className="text-white text-lg sm:text-xl md:text-xl font-semibold tracking-wide ml-12 md:ml-10">
