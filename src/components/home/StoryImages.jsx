    ...
    return (
        <section className="bg-[#FCFAEE] py-16 px-6">
            <article className="max-w-6xl mx-auto">
                <p className="text-[#4A4238] text-justify md:text-center text-lg md:text-2xl font-semibold mb-10 leading-relaxed px-4">
                    Dos generaciones enfrentan la nostalgia y el deseo de pertenencia,
